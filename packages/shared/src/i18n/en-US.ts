...
export const enUS = {
  ...
  login: {
    ...
    oidcSubmit: "Sign in with SSO",
    oidcWebOnly: "SSO is web-only in this release. Continue using your username and password in the desktop app.",
    passwordFallback: "Or use a username and password",
    oidcEmailNotAllowed: "This identity is not allowed to sign in to this instance.",
    oidcProvisioningDisabled: "This identity is not linked to an EdgeEver user.",
    oidcInvalidState: "This sign-in request expired or was already used. Start SSO again.",
    oidcNotConfigured: "SSO is not configured for this instance.",
    oidcCallbackFailed: "SSO failed. Try again or use the fallback password.",
