...
export const zhCN = {
  ...
  login: {
    ...
    submit: "开启工作区",
    oidcSubmit: "使用统一身份登录",
    oidcWebOnly: "统一身份登录第一期仅支持网页端；桌面端请继续使用账号密码。",
    passwordFallback: "或使用账号密码",
    oidcEmailNotAllowed: "这个统一身份账号不在允许登录的名单中。",
    oidcProvisioningDisabled: "这个统一身份账号尚未绑定到 EdgeEver 用户。",
    oidcInvalidState: "登录验证已过期或已被使用，请重新发起统一身份登录。",
    oidcNotConfigured: "这个实例尚未完成统一身份登录配置。",
    oidcCallbackFailed: "统一身份登录失败，请重试或使用备用密码登录。",
